...
var v3_0ChartMapping = map[string]chartRenderingDetails{
	DiscoveryChart: {
...
type versionStrategyV3_0 struct {
	Ver
	conversionImpl v2xConversionStrategy
}

var _ VersionStrategy = (*versionStrategyV3_0)(nil)

func (v *versionStrategyV3_0) SetImageValues(_ context.Context, _ *common.ControllerResources, smcpSpec *v1.ControlPlaneSpec) error {
	if err := common.UpdateField(smcpSpec.Istio, "grafana.image", common.Config.OLM.Images.V3_0.Grafana); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "pilot.image", common.Config.OLM.Images.V3_0.Pilot); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "prometheus.image", common.Config.OLM.Images.V3_0.Prometheus); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "global.proxy.image", common.Config.OLM.Images.V3_0.ProxyV2); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.Istio, "rateLimiting.rls.image", common.Config.OLM.Images.V3_0.RLS); err != nil {
		return err
	}
	if err := common.UpdateField(smcpSpec.ThreeScale, "image", common.Config.OLM.Images.V3_0.ThreeScale); err != nil {
		return err
	}
	return nil
}

func (v *versionStrategyV3_0) ValidateV1(_ context.Context, _ client.Client, _ *v1.ServiceMeshControlPlane) error {
	return fmt.Errorf("must use v2 ServiceMeshControlPlane resource for v2.0+ installations")
}

func (v *versionStrategyV3_0) ValidateV2(ctx context.Context, cl client.Client, meta *metav1.ObjectMeta, spec *v2.ControlPlaneSpec) error {
	var allErrors []error
...
func (v *versionStrategyV3_0) validateRuntime(spec *v2.ControlPlaneSpec, allErrors []error) []error {
...
func (v *versionStrategyV3_0) validateMixerDisabled(spec *v2.ControlPlaneSpec, allErrors []error) []error {
...
func (v *versionStrategyV3_0) validateAddons(spec *v2.ControlPlaneSpec, allErrors []error) []error {
	if spec.Addons == nil {
		return allErrors
	}
...
func (v *versionStrategyV3_0) validateServiceMeshExtensionsRemoved(ctx context.Context, cl client.Client, smcp metav1.Object) error {
...
func (v *versionStrategyV3_0) ValidateV2Full(ctx context.Context, cl client.Client, meta *metav1.ObjectMeta, spec *v2.ControlPlaneSpec) error {
	var allErrors []error
...
func (v *versionStrategyV3_0) ValidateDowngrade(ctx context.Context, cl client.Client, smcp metav1.Object) error {
	// TODO: what might prevent us from downgrading?
	return nil
}

func (v *versionStrategyV3_0) ValidateUpgrade(ctx context.Context, cl client.Client, smcp metav1.Object) error {
	return v.validateServiceMeshExtensionsRemoved(ctx, cl, smcp)
}

func (v *versionStrategyV3_0) ValidateUpdate(ctx context.Context, cl client.Client, oldSMCP, newSMCP metav1.Object) error {
...
func (v *versionStrategyV3_0) ValidateRequest(ctx context.Context, cl client.Client, req admission.Request, smcp metav1.Object) admission.Response {
...
func (v *versionStrategyV3_0) isRequesterClusterAdmin(ctx context.Context, cl client.Client, req admission.Request) (bool, error) {
...
func (v *versionStrategyV3_0) GetChartInstallOrder() [][]string {
	return v3_0ChartOrder
}

// TODO: consider consolidating this with 2.0 rendering logic
func (v *versionStrategyV3_0) Render(ctx context.Context, cr *common.ControllerResources, cniConfig cni.Config,
	...
	if isComponentEnabled(spec.Istio, v3_0ChartMapping[TracingChart].enabledField) {
	...
	if isComponentEnabled(spec.Istio, v3_0ChartMapping[KialiChart].enabledField) {
	...
	for name, chartDetails := range v3_0ChartMapping {
		...
		if chartDetails.enabledField == "" || isComponentEnabled(spec.Istio, chartDetails.enabledField) {
			...
			chart := path.Join(v.GetChartsDir(), v3_0ChartMapping[name].path)
	...
	if isEnabled(spec.ThreeScale) {
		...
		if chartRenderings, _, err := helm.RenderChart(
			path.Join(v.GetChartsDir(), v3_0ChartMapping[ThreeScaleChart].path),
...
func (v *versionStrategyV3_0) renderIngressGateway(name, namespace, kubeVersion string, gateways map[string]interface{},
	values *v1.HelmValues, userIDAutoassigned bool,
) (map[string][]manifest.Manifest, map[string]interface{}, error) {
	return v.renderGateway(name, namespace, kubeVersion, v3_0ChartMapping[GatewayIngressChart].path, "istio-ingressgateway", gateways, values, userIDAutoassigned)
}

func (v *versionStrategyV3_0) renderEgressGateway(name, namespace, kubeVersion string, gateways map[string]interface{},
	values *v1.HelmValues, userIDAutoassigned bool,
) (map[string][]manifest.Manifest, map[string]interface{}, error) {
	return v.renderGateway(name, namespace, kubeVersion, v3_0ChartMapping[GatewayEgressChart].path, "istio-egressgateway", gateways, values, userIDAutoassigned)
}

func (v *versionStrategyV3_0) renderGateway(name, namespace, kubeVersion string, chartPath string, typeName string,
...
func (v *versionStrategyV3_0) GetExpansionPorts() []corev1.ServicePort {
	return v.conversionImpl.GetExpansionPorts()
}

func (v *versionStrategyV3_0) GetTelemetryType(in *v1.HelmValues, mixerTelemetryEnabled, mixerTelemetryEnabledSet, remoteEnabled bool) v2.TelemetryType {
	return v.conversionImpl.GetTelemetryType(in, mixerTelemetryEnabled, mixerTelemetryEnabledSet, remoteEnabled)
}

func (v *versionStrategyV3_0) GetPolicyType(in *v1.HelmValues, mixerPolicyEnabled, mixerPolicyEnabledSet, remoteEnabled bool) v2.PolicyType {
	return v.conversionImpl.GetPolicyType(in, mixerPolicyEnabled, mixerPolicyEnabledSet, remoteEnabled)
}

func (v *versionStrategyV3_0) GetTrustDomainFieldPath() string {
